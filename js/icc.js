...
(function () {
  const ICC_ITEMS = [
    { id: 1,  emoji: '🍶', name: '寶特瓶',         cat: 'beverage', stars: 5, hint: '台灣海廢第 2 名。瓶身 + 瓶蓋常分開漂。' },
    { id: 2,  emoji: '🔘', name: '塑膠瓶蓋',       cat: 'beverage', stars: 5, hint: '台灣 + 全球海廢第 1 名。比瓶身更難回收。' },
    { id: 3,  emoji: '🥡', name: '其他飲料/食物容器', cat: 'food', stars: 4, hint: '便當盒、外帶餐盒——常見到不行。' },
    { id: 4,  emoji: '🧴', name: '非食物的瓶罐',   cat: 'other',    stars: 2, hint: '洗髮精、清潔劑、化學品的瓶子。' },
    { id: 5,  emoji: '🛍️', name: '塑膠提袋',       cat: 'food',     stars: 5, hint: '台灣每人每年用掉 800 個。' },
    { id: 6,  emoji: '🍪', name: '食品包裝袋',     cat: 'food',     stars: 4, hint: '零食袋、糖果紙、餅乾包裝。' },
    { id: 7,  emoji: '🥤', name: '吸管',           cat: 'food',     stars: 5, hint: '改變一個國家政策的那種——案件 02。' },
    { id: 8,  emoji: '☕', name: '外帶飲料杯',     cat: 'beverage', stars: 4, hint: '手搖飲杯。台灣每年用 50 億個。' },
    { id: 9,  emoji: '🍴', name: '免洗餐具',       cat: 'food',     stars: 4, hint: '筷子、叉子、湯匙——一次性的。' },
    { id: 10, emoji: '🍾', name: '玻璃瓶',         cat: 'beverage', stars: 3, hint: '會碎裂——但要 100 萬年才會分解。' },
    { id: 11, emoji: '🥫', name: '鐵鋁罐',         cat: 'beverage', stars: 3, hint: '可樂罐、啤酒罐。回收率比塑膠高。' },
    { id: 12, emoji: '🧃', name: '鋁箔包/利樂包',  cat: 'beverage', stars: 3, hint: '蘋果汁、豆漿那種——多層材料超難回收。' },
    { id: 13, emoji: '🎣', name: '釣魚用具',       cat: 'fishing',  stars: 2, hint: '魚線、魚鉤、鉛塊——最危險。' },
    { id: 14, emoji: '🟠', name: '漁業浮球',       cat: 'fishing',  stars: 4, hint: '蚵棚的橘色浮球。西部海岸超多。' },
    { id: 15, emoji: '⬜', name: '保麗龍浮筒',     cat: 'fishing',  stars: 4, hint: '碎成沙子大小——白色污染主犯。' },
    { id: 16, emoji: '🛟', name: '漁船防碰墊',     cat: 'fishing',  stars: 1, hint: '漁港邊常見，不太會跑到海邊。' },
    { id: 17, emoji: '🕸️', name: '漁網與繩子',     cat: 'fishing',  stars: 4, hint: '幽靈漁網——案件 03。' },
    { id: 18, emoji: '🚬', name: '菸蒂',           cat: 'hazard',   stars: 5, hint: '全球海廢第 1 名！每年 4.5 兆根。' },
    { id: 19, emoji: '🪥', name: '牙刷',           cat: 'hazard',   stars: 2, hint: '為什麼會在海邊？想想看。' },
    { id: 20, emoji: '😷', name: '口罩',           cat: 'hazard',   stars: 3, hint: '2022 新增的第 20 項——疫情後變多。' }
  ];
